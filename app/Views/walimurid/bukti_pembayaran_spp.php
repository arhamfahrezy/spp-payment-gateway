<?php
    // C:\xampp\htdocs\payment-gateway\app\Views\walimurid\bukti_pembayaran_spp.php
    // Format Rupiah
...
<div class="receipt-container">
    ...
    <div class="info-section">
        ...
        <div class="info-box">
            ...
            <?php
                // Logika untuk menentukan teks status dan tanggal
                ...
                if ($isLunas) {
                    ...
                    $statusClass = 'text-info fw-bold'; // Menggunakan warna biru info
    ...
    <div class="card mb-3">
        ...
        <div class="card-body p-4">
             <div class="d-flex justify-content-between fs-6">
                ...
                <strong class="text-primary"><?= format_rupiah($tagihan['nominal']) ?></strong>
            </div>
             <hr>
             <div class="d-flex justify-content-between fs-6">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="text-center">Tidak ada rincian pembayaran yang ditemukan.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
    ...
    <div class="text-center mt-4 no-print">
        <button onclick="window.print()" class="btn btn-primary"><i class="bi bi-printer me-2"></i>Cetak Bukti Pembayaran</button>
        <a href="<?= site_url('walimurid/riwayat_pembayaran') ?>" class="btn btn-secondary">Kembali ke Riwayat</a>
    </div>
