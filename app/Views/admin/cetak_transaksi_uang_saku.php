<!-- C:\xampp\htdocs\payment-gateway\app\Views\admin\cetak_transaksi_uang_saku.php -->
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
...
<body>
    <?php
        // MODIFIKASI: Inisialisasi formatter tanggal di sini
        ...
        <main class="invoice-body">
            ...
            <table class="receipt-table">
                ...
                <tr>
                    ...
                    <!-- MODIFIKASI: Menggunakan formatter Indonesia -->
                    <td class="value"><?= $dateTimeFormatter->format(strtotime($transaksi['tanggal'])) ?></td>
                </tr>
                <tr>
                    <td class="label">Nama Siswa</td>
                    <td class="value"><?= esc($transaksi['nama_siswa']) ?></td>
                </tr>
                <tr>
                    <td class="label">NIS / Kelas</td>
                    <td class="value"><?= esc($transaksi['nis']) ?> / <?= esc($transaksi['kelas']) ?></td>
                </tr>
                <tr>
